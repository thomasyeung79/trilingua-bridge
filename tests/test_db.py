...
def test_reserve_sqlite_mode_without_postgres():
    ...
    from db_helper import reserve_daily_usage, _use_postgres
    assert _use_postgres() is False
...
def test_logged_in_username_unchanged():
    ...
    from db_helper import reserve_daily_usage, get_daily_usage_remaining
...
def test_login_normalizes_username():
    ...
    _ensure_users_table()
    from db_helper import create_user, authenticate_user

...
TEXTS = {
    "en": {
        ...
        "landing_value": "translates not just words. It understands tone, culture, and context across Chinese, English, Korean, Cantonese, and Japanese.",
        ...
        "landing_no_commit": "No account needed to try - guest mode works immediately. Sign up only if you want to save history.",
        "reply": "Korean reply",
        "tone": "Tone analysis",
    ...
    "zh": {
        ...
        "landing_value": "不仅翻译文字，还理解中文、英文、韩文、粤语和日文之间的语气、文化和上下文。",
        "features_label": "功能",
        "landing_features_title": "你可以做什么",
        "preview_label": "预览",
        "landing_preview_title": "看看实际效果",
        "preview_example": "示例：韩语礼貌回复",
        "preview_user_text": "“前辈邀请我吃晚饭，但我需要婉拒，怎样用韩语礼貌回复？”",
        "preview_you_asked": "你的问题：",
        "preview_ai_suggests": "AI 建议：",
        "preview_honorific": "敬语：-습니다 形式",
        "landing_no_commit": "无需账号即可试用，访客模式可立即使用。只有想保存历史时才需要注册。",
        "reply": "韩语回复",
        "tone": "语气分析",
        "cultural": "文化说明",
        "nav_home": "首页",
...
TEXTS["ko"] = {
    ...
    **{
        ...
        "landing_value": "단어만 번역하지 않고 중국어, 영어, 한국어, 광둥어, 일본어 사이의 어조, 문화, 맥락을 이해합니다.",
        "features_label": "기능",
        "landing_features_title": "무엇을 할 수 있나요?",
        "preview_label": "미리보기",
        ...
        "landing_no_commit": "계정 없이 바로 체험할 수 있습니다. 기록을 저장하고 싶을 때만 가입하세요.",
        "reply": "한국어 답장",
        "tone": "어조 분석",
        "cultural": "문화 메모",
...
TEXTS["yue"] = {
    ...
    **{
        ...
        "landing_value": "唔止翻譯文字，仲理解中文、英文、韓文、粵語同日文之間嘅語氣、文化同上下文。",
        "features_label": "功能",
        "landing_features_title": "你可以做啲咩",
        "preview_label": "預覽",
        "landing_preview_title": "睇吓實際效果",
        "preview_example": "例子：韓文禮貌回覆",
        "preview_user_text": "「前輩約我食晚飯，但我需要婉拒，點樣用韓文禮貌回覆？」",
        "preview_you_asked": "你問：",
        "preview_ai_suggests": "AI 建議：",
        "preview_honorific": "敬語：-습니다 形式",
        "landing_no_commit": "唔使開帳號都可以即刻試用。想儲存歷史先需要註冊。",
        "reply": "韓文回覆",
        "tone": "語氣分析",
        "cultural": "文化提示",
...
TEXTS["ja"] = {
    ...
    **{
        ...
        "landing_value": "言葉だけでなく、中国語、英語、韓国語、広東語、日本語の間にあるトーン、文化、文脈まで理解します。",
        "features_label": "機能",
        "landing_features_title": "できること",
        "preview_label": "プレビュー",
        "landing_preview_title": "実際の例を見る",
        "preview_example": "例：韓国語の丁寧な返信",
        "preview_user_text": "「先輩に夕食へ誘われましたが、丁寧に断る必要があります。韓国語でどう返信すればいいですか？」",
        "preview_you_asked": "あなたの質問：",
        "preview_ai_suggests": "AI の提案：",
        "preview_honorific": "敬語：-습니다 体",
        "landing_no_commit": "アカウントなしですぐ試せます。履歴を保存したい場合だけ登録してください。",
        "reply": "韓国語の返信",
        "tone": "トーン分析",
        "cultural": "文化メモ",
        "nav_home": "ホーム",

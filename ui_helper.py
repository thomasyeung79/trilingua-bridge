...
TEXTS = {
    "en": {
        ...
        "provider_auto_option": "Auto: OpenAI first, DeepSeek fallback",
        "all_filter": "All",
        ...
        "hero_langs": "Mandarin · Cantonese · Korean · English",
        ...
        "phonetic_input_tip": "You can type pinyin, Jyutping/Cantonese romanization, or Korean romanization directly.",
    ...
    "zh": {
        ...
        "model": "模型",
        "ai_provider": "AI 模型服务",
        "provider_auto_option": "自动：优先 OpenAI，失败时切换 DeepSeek",
        "all_filter": "全部",
        "tts_too_long": "文本太长，暂时无法朗读。请缩短一点再试。",
        "show_pron": "显示发音与朗读",
        "tip": "提示：输入越具体越好。",
        "hero_langs": "普通话 · 粤语 · 韩语 · 英语",
        ...
        "phonetic_input_tip": "支持直接输入拼音、粤拼/粤语罗马字、韩语罗马字。",
...
TEXTS["ko"] = {
    ...
    **{
        ...
        "phonetic_input_tip": "병음, 광둥어 로마자/월병, 한국어 로마자 입력도 바로 인식합니다.",
...
TEXTS["yue"] = {
    ...
    **{
        ...
        "model": "模型",
        "ai_provider": "AI 模型服務",
        "provider_auto_option": "自動：優先 OpenAI，失敗時切換 DeepSeek",
        "all_filter": "全部",
        "tts_too_long": "文字太長，暫時朗讀唔到。請縮短少少再試。",
        "show_pron": "顯示發音同朗讀",
        "tip": "貼士：輸入越短越具體，效果越好。",
        "hero_langs": "普通話 · 粵語 · 韓文 · 英文",
        ...
        "phonetic_input_tip": "可以直接輸入拼音、粵拼/粵語羅馬字，或者韓文羅馬字。",
...
TEXTS["ja"] = {
    ...
    **{
        ...
        "provider_auto_option": "自動：OpenAI優先、失敗時DeepSeek→Anthropicフォールバック",
        "all_filter": "すべて",
